...
/**
 * Keeps the custom PhotoX recipe editor available without hijacking the real
 * IMG.LY photo editor. Native editing is now the default because it provides
 * actual pixel rendering, live preview and artifact export.
 *
 * Pass metadata.__photoxUseCustomEditor === true only when the caller
 * explicitly wants the experimental recipe UI.
 */
