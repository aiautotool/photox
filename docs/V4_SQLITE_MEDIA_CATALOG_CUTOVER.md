...
## Active cutover work
1. Wire the role-safe catalog diagnostics contract into authenticated Desktop/Web admin/operations transport with role enforcement. Unauthorized/non-operator Web sessions must receive only the workspace-safe shape.
